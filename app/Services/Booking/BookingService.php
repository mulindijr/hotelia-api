...
class BookingService
{
    ...
    public function create(Hotel $hotel, array $data): Booking
    {
        ...
        // 2. Fetch rooms details and compute nights
        $rooms = Room::whereIn('id', $data['rooms'])->with('roomType')->get();
        ...
        // 3. Attach services and compute cost
        $servicesCost = 0;
        $servicesData = [];
    ...
    public function update(Booking $booking, array $data): Booking
    {
        ...
        $rooms = Room::whereIn('id', $roomIds)->with('roomType')->get();
        $totalRoomCost = $rooms->sum(fn($r) => $r->roomType->base_price * $nights);
